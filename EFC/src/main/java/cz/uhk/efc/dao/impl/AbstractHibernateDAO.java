 ...
 * Je to super vec na hadlovani veskerych zavislosti. Pokud bude nejaka trida trochu slozitechsi tak se
 * odvodi. Implementuje zakladni rozhrani IOperations pro komunikaci
 * 
 * @author roman
 *
 */
